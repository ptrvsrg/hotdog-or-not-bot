...
from bot.app.config import ConfigModel
...
def load_config() -> ConfigModel:
    ...
    config_data: dict = {
        ...
        "detect_model": {"path": os.getenv("DETECT_MODEL_PATH")},
        "predict_model": {"path": os.getenv("PREDICT_MODEL_PATH")},
        "bot": {
        ...
        "server": {"debug": os.getenv("DEBUG", False), "port": os.getenv("PORT", 8080)},
    }
